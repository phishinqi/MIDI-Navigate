  ...
  return (
    <div className="flex-1 p-6 overflow-y-auto bg-black/20">
      <div className="mb-6">
        ...
        <div className="w-full p-4 rounded-lg text-[10px] font-sans tabular-nums overflow-auto max-h-[400px] border border-white/10 bg-black/40 text-green-400/80 shadow-inner">
          {analysisData ? (
      ...
      <div>
        ...
        <div className="w-full p-4 rounded-lg text-[10px] font-sans tabular-nums overflow-auto border border-white/10 bg-black/40 text-blue-400/80 shadow-inner">
