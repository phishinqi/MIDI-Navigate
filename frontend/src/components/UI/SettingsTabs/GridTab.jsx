          ...
          {renderEngine === 'p5' && (
            <div className="space-y-5 animate-in fade-in duration-300">
                <div className="p-3 bg-white/5 border border-white/10 rounded text-xs text-white/50 mb-2 flex items-center gap-2">
                    <Monitor size={14} />
                    <span>P5 Renderer Settings</span>
                </div>

                {/* Visual Style Selector */}
                <div className="space-y-2">
                    <div className="flex justify-between text-[10px] font-bold text-white/70"><span>Visual Style</span></div>
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-2 rounded border transition-all ${
                                (percussionSettings.p5Style === 'geometry' || !percussionSettings.p5Style) 
                                ? 'bg-midi-accent text-white border-midi-accent' 
                                : 'bg-white/5 text-white/50 border-transparent hover:bg-white/10'
                            }`}
                        >
                            <Shapes size={16} className="mb-1" />
                            <span className="text-[9px] uppercase">Geometric</span>
                        </button>
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-2 rounded border transition-all ${
                                percussionSettings.p5Style === 'energy' 
                                ? 'bg-midi-accent text-white border-midi-accent' 
                                : 'bg-white/5 text-white/50 border-transparent hover:bg-white/10'
                            }`}
                        >
                            <Sparkles size={16} className="mb-1" />
                            <span className="text-[9px] uppercase">Energy</span>
                        </button>
                         ...
                         <button
                            ...
                            className={`flex flex-col items-center justify-center p-2 rounded border transition-all ${
                                percussionSettings.p5Style === 'monochrome' 
                                ? 'bg-midi-accent text-white border-midi-accent' 
                                : 'bg-white/5 text-white/50 border-transparent hover:bg-white/10'
                            }`}
                        >
                            <Activity size={16} className="mb-1" />
                            <span className="text-[9px] uppercase">Blueprint</span>
                        </button>
                    </div>
                </div>
