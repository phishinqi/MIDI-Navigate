                ...
                <div className="space-y-2 pt-2 border-t border-white/5">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-2 items-center">
                            <label className="flex-1 flex items-center justify-center p-2 rounded bg-black/20 border border-white/10 hover:bg-white/5 cursor-pointer text-xs transition-colors">
                            ...
                            {isSoundFontLoaded && (
                                <button
                                    ...
                                    className="px-3 py-2 rounded bg-red-500/20 text-red-300 border border-red-500/30 text-xs hover:bg-red-500/30"
                                >
