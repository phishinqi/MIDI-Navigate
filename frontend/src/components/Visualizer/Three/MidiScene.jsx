...
import { getTrackHue, isLightColor } from '../../../lib/utils.js';
...
const MidiScene = () => {
  ...
  }, [midiData, zoomX, zoomY, laneHeightScale]);
  ...
  const { count, instances } = useMemo(() => {
    ...
    midiData.tracks.forEach((track, tIdx) => {
      ...
      const baseColor = new THREE.Color().setHSL(hue / 360, 0.8, 0.5);
  ...
  }, [midiData, viewport.height, zoomX, zoomY, laneHeightScale]);
