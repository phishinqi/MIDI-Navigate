...
interface StoreState {
  ...
  showAnalysisWidget: boolean;
  togglePlayerWidget: () => void;
  toggleAnalysisWidget: () => void;
  backgroundColor: string;
  setBackgroundColor: (color: string) => void;
  autoTextContrast: boolean;
  toggleAutoTextContrast: () => void;
  forceDarkText: boolean;
  toggleForceDarkText: () => void;
  isGlowEnabled: boolean;
  toggleGlow: () => void;
  trackColors: Record<number, string>;
  useDefaultTrackColors: boolean;
  setTrackColor: (trackIndex: number, color: string) => void;
  resetTrackColors: () => void;
  setUseDefaultTrackColors: (value: boolean) => void;
  p5Settings: any;
  setP5Settings: (settings: any) => void;
  addP5CurvePreset: (name: string, curve: number[]) => void;
  removeP5CurvePreset: (name: string) => void;
  applyP5CurvePreset: (name: string) => void;
  percussionSettings: any;
  setPercussionSettings: (settings: any) => void;
  viewSettings: any;
  pixiSettings?: any;
  ...
  setAnalysisSensitivity: (val: number) => void;
  ...
  analysisTrackIndices: number[];
  mutedTrackIndices: number[];
  toggleTrackMute: (index: number) => void;
  toggleTrackVisibility: (index: number) => void;
  toggleAnalysisTrack: (index: number) => void;
  ...
  toggleMute: () => void;
  reset: () => void;
  setMidiData: (data: any, file: any) => void;
  isPlaying: boolean;
  currentTime: number;
  duration: number;
  volume: number;
  isMuted: boolean;
  pedalActive: boolean;
  setPedalActive: (val: boolean) => void;
  ccValues: Record<number, Record<number, number>>;
  setCcValue: (channel: number, cc: number, val: number) => void;
  midiOutputs: any[];
  selectedMidiOutput: string | null;
  useInternalAudio: boolean;
  setMidiOutputs: (outputs: any[]) => void;
  autoSelectMidiDevice: (outputs: any[]) => string | null;
  setSelectedMidiOutput: (id: string) => void;
  toggleInternalAudio: () => void;
