...
export class SettingsManager {
    ...
    // ... loadSettings, saveSettings, updateSetting, get, toggleChannel, isChannelEnabled, toggleModal ...
    // (这些方法保持不变，为节省篇幅省略，请保留原有的实现)
    ...
    // ... Helpers (addSectionHeader, createToggle, etc. 保持不变) ...
    addSectionHeader(parent, text) { const h = document.createElement('div'); h.innerText = text; h.style.cssText = 'font-size: 10px; font-weight: bold; color: rgba(255,255,255,0.3); text-transform: uppercase; letter-spacing: 1px; margin: 15px 0 6px 0; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 4px;'; parent.appendChild(h); }
